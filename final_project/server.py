...
def englishToFrench():
    ...
    print("Translated text to French:", translated_text)  # Log the translated text to console
...
def frenchToEnglish():
    ...
    print("Translated text to English:", translated_text)  # Log the translated text to console
